...
import geiffel.da4.issuetracker.user.UserController;
...
public class ProjetControllerTest {
    ...
    void setUp() {
        projets = new ArrayList<>() {{
            add(new Projet(1L, "Machin"));
            add(new Projet(2L, "Chose"));
            add(new Projet(3L, "Truc"));
            add(new Projet(14L, "higher"));
            add(new Projet(7L, "lower"));
            add(new Projet(28L, "way higher"));
        }};
